        ...
        <div className="flex-1">
          ...
          <div className="collapse collapse-arrow rounded-none bg-gray-50">
            ...
            <div className="collapse-content">
              <p>
                HavenHQ offers a wide range of properties including apartments,
                houses, Student housing, townhouses, and Vacation rentals
                properties. You can find properties for sale, rent, or lease
          ...
          <div className="collapse collapse-arrow rounded-none bg-gray-50">
            ...
            <div className="collapse-content">
              <p>
                No, there are no hidden fees when using HavenHQ. Our services
                are completely transparent, and any applicable fees or charges
                will be clearly communicated to you upfront.
              </p>
            </div>
          </div>
          <div className="collapse collapse-arrow rounded-none bg-gray-50">
            ...
            <div className="collapse-content">
              <p>
                Yes, HavenHQ works with trusted financial partners who can
                assist you with mortgage pre-approval and financing options
                tailored to your needs. Contact us for more information.
              </p>
            </div>
          </div>
          <div className="collapse collapse-arrow rounded-none bg-gray-50">
            ...
            <div className="collapse-content">
              <p>
                Yes, we strive to ensure that all information displayed on our
                listings is accurate and up-to-date. Our team verifies the
                details provided by sellers and agents to maintain the integrity
                of our platform. If you have any concerns about a listing,
          ...
          <div className="collapse collapse-arrow rounded-none bg-gray-50">
            ...
            <div className="collapse-content">
              <p>
                At HavenHQ, we take data privacy and security seriously. We
                adhere to strict privacy policies and employ industry-standard
                encryption and security measures to safeguard your personal
                information. Your data is kept confidential and used only for
                legitimate purposes outlined in our privacy policy.
              </p>
            </div>
          </div>
        </div>
        <div className="flex-1">
          <div className=" w-full p-6 bg-white rounded-none border shadow-none lg:mt-3">
            ...
            <form action="#" method="POST">
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  name="message"
                  rows="4"
                  className="mt-1 block w-full rounded-none border-gray-300 shadow-none border focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                ></textarea>
              </div>
              <div className="text-right">
                <button
                  type="submit"
                  className="btn bg-[#0077be] rounded-none text-white hover:text-black"
                >
                  Submit
                </button>
              </div>
